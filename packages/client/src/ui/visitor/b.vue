	...
	<div class="main">
		...
		<div class="contents">
			...
			<div v-if="!root" class="powered-by">
				<b><MkA to="/">{{ host }}</MkA></b>
				<small>Powered by <a href="https://github.com/ganngi-mari/missnemone" target="_blank">Misskey</a></small>
			</div>
		</div>
	</div>
